        ...
        <div>
            <?php
                ...
                while ($row = mysqli_fetch_array($result)) {?>
                    <div class="slides not-active">
                      <div id="div11">
                    <p id="p-as" style="margin-top:50px;"><?php echo $row['name']; ?></p>
                </div>
                <div id="div12">
                    <img class="pic" src="<?php echo 'data:image/jpeg;base64,'.base64_encode($row['photo']);?>"
                        style="margin-left: 28vw;">
                    <p class="price-info" style="margin-left: 570px;"><?php echo $row['price']; ?></p>
                    <a href="Purch-end.php" class="a-P" style="margin-left: 545px;">Purchase</a>
                    <p class="p-users"><?php echo $row['creator']; ?></p>
